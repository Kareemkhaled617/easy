import 'package:esay/utils/MLDataProvider.dart';
              ...
              child: Row(
                children: [
                  ...
                  Stack(
                    children: [
                      CircleAvatar(
                        ...
                        radius: 28.0,
                        child: Image.asset('assets/images/man.png', fit: BoxFit.cover).cornerRadiusWithClipRRect(30.0),
                      ),
                      const Positioned(
                        right: 0,
                        bottom: 6,
                  ...
                  Column(
                    ...
                    children: [
                      Text('Tony Bot ', style: boldTextStyle(color: whiteColor, size: 18)),
                      4.height,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  CircleAvatar(
                                    ...
                                    child: Image.asset('assets/images/man.png', fit: BoxFit.fill).cornerRadiusWithClipRRect(30.0),
                                  ),
                                ],
                              ),
                            ],
